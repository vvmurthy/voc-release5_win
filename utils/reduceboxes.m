...
%These are personal checkpoints for partially occluded detections- the
%software in the original R. Girshick version does not have a specific
%'checkpoint' against complete non-detection images. So this mitigates that
checkbox = isempty(b);
if checkbox == 1
    b = [ 0 0 0 0];
